...
class TestRenderer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        portal.invokeFactory('Cinema Folder', 'cf1')
        portal.invokeFactory('Cinema Folder', 'cf2')
        
        portal['cf1'].invokeFactory('Promotion', 'p1')
        portal['cf1'].invokeFactory('Promotion', 'p2')
        portal['cf1'].invokeFactory('Promotion', 'p3')
        portal['cf1'].invokeFactory('Promotion', 'p4')
        portal['cf1'].invokeFactory('Promotion', 'p5')
        portal['cf2'].invokeFactory('Promotion', 'p6')
        portal['cf2'].invokeFactory('Promotion', 'p7')
